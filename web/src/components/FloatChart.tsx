...
import type { FloatMonth } from "@/lib/queries";
...
export function FloatChart({ data }: { data: FloatMonth[] }) {
  ...
  return (
    <ResponsiveContainer width="100%" height={420}>
      <ComposedChart data={data}>
        ...
        <Bar yAxisId="amt" dataKey="gainOneOff" name="one-off purchases" stackId="1" fill={t.series.primary} />
        <Bar yAxisId="amt" dataKey="gainInstallment" name="installments" stackId="1" fill={t.series.band} radius={[3, 3, 0, 0]} />
