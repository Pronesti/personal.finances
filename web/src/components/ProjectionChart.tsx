  ...
  return (
    <ResponsiveContainer width="100%" height={420}>
      <ComposedChart data={shaped}>
        ...
        <Bar dataKey="certain" name={tr("future.legend.certain")} stackId="s" fill={t.series.primary} />
        <Bar dataKey="expected" name={tr("future.legend.expected")} stackId="s" fill={t.series.secondary} />
        <Area dataKey="bandBase" stackId="b" stroke="none" fill="none" legendType="none" />
        <Area dataKey="bandSpan" name={tr("future.legend.estimated")} stackId="b"
