...
const en = {
  ...
  "categories.table.receipt": "receipt",
  ...
  "calendar.tip.charges.one": "{count} charge",
  "calendar.tip.charges.other": "{count} charges",
  "calendar.tip.click": "click for detail",
  "calendar.day.total": "Total",
  "calendar.day.charges": "Charges",
  "calendar.day.categories": "Categories",
  "calendar.day.close": "close",
  "calendar.day.brand": "Card",
  "calendar.day.statement": "Statement",
  "calendar.day.installments": "{n} installments",
  "calendar.day.hint": "Click a cell to see everything bought that day.",
  ...
  "failure.ocr_failed.tooMuchOutput": "ocr_receipt.py produced more output than expected.",
  ...
  "receipts.drop.leave": "The receipt is still being read. If you leave now, the upload is lost. Leave anyway?",
  ...
  "super.review.rematch": "Re-match every receipt",
  "super.review.rematchNote": "Rebuilds every line's product from the current codes and rules. Use it after moving a code, or for receipts read before products existed.",
...
const es: Dictionary = {
  ...
  "categories.table.receipt": "ticket",
  ...
  "calendar.tip.charges.one": "{count} cargo",
  "calendar.tip.charges.other": "{count} cargos",
  "calendar.tip.click": "clic para el detalle",
  "calendar.day.total": "Total",
  "calendar.day.charges": "Cargos",
  "calendar.day.categories": "Categorías",
  "calendar.day.close": "cerrar",
  "calendar.day.brand": "Tarjeta",
  "calendar.day.statement": "Resumen",
  "calendar.day.installments": "{n} cuotas",
  "calendar.day.hint": "Hacé clic en una celda para ver todo lo comprado ese día.",
  ...
  "failure.ocr_failed.tooMuchOutput": "ocr_receipt.py produjo más salida de la esperada.",
  ...
  "receipts.drop.leave": "El ticket todavía se está leyendo. Si salís ahora, la carga se pierde. ¿Salir igual?",
  ...
  "super.review.rematch": "Volver a asignar todos los tickets",
  "super.review.rematchNote": "Reconstruye el producto de cada línea con los códigos y reglas actuales. Usalo después de mover un código, o para tickets leídos antes de que existieran los productos.",
