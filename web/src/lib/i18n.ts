...
const en = {
  ...
  "bank.tile.utilization.detail": "{balance} of {limit} at the latest close",
  "bank.tile.none": "no data on the latest statement",
  "bank.tile.limitReal": "Limit, real terms",
  "bank.tile.limitReal.detail": "per card, purchasing power vs {months} months ago",
  "bank.tile.realTem": "Real cost of revolving",
  "bank.tile.realTem.value": "{pct}/mo",
  "bank.tile.realTem.detail": "TEM {tem}% vs {infl}% monthly inflation",
  "bank.tile.realTem.stale": "no CPI for the latest cycle yet",
  "bank.headroomHeading": "Balance vs limit",
  "bank.headroomNote": "The limit line is per card — the bank moves both cards together — while the bars sum both cards' balances, so a month missing one card's statement dips accordingly. Utilization is a nominal ratio and reads the same in every value mode; the balance includes the USD part at that month's MEP.",
  "bank.ratesHeading": "Financing rate vs inflation",
  "bank.ratesNote": "TEM is the monthly effective financing rate each statement prints. The dashed line is what revolving costs in purchasing power: below zero, inflation pays the interest.",
  "bank.legend.balance": "Closing balance",
  "bank.legend.limit": "Purchase limit (per card)",
  "bank.legend.utilization": "Utilization",
  "bank.legend.tem": "TEM (monthly)",
  "bank.legend.inflation": "Inflation m/m",
  "bank.legend.realTem": "Real monthly rate",
  "bank.footer": "This page reads the terms the bank prints on each statement: the purchase limit, the closing balance, and the financing rate. The first chart compares the balance with the limit. The dashed line is the part of the limit in use. A low value means free margin for a big month or an emergency. The second chart compares the monthly financing rate with monthly inflation. The blue dashed line is the real rate. When that line is under zero, the rate is lower than inflation, so a financed balance loses value slower than the pesos used to pay it. When the line is over zero, revolving has a true cost. The middle tile restates the limit in constant pesos. A limit frozen in nominal pesos becomes smaller in real terms every month; when it falls too much, that is the moment to ask the bank for a raise.",
...
const es: Dictionary = {
  ...
  "bank.tile.utilization.detail": "{balance} de {limit} al último cierre",
  "bank.tile.none": "sin datos en el último resumen",
  "bank.tile.limitReal": "Límite, en términos reales",
  "bank.tile.limitReal.detail": "por tarjeta, poder de compra vs {months} meses atrás",
  "bank.tile.realTem": "Costo real de refinanciar",
  "bank.tile.realTem.value": "{pct}/mes",
  "bank.tile.realTem.detail": "TEM {tem}% vs {infl}% de inflación mensual",
  "bank.tile.realTem.stale": "todavía no hay IPC para el último ciclo",
  "bank.headroomHeading": "Saldo vs límite",
  "bank.headroomNote": "La línea del límite es por tarjeta — el banco mueve las dos juntas — mientras que las barras suman los saldos de ambas, así que un mes sin el resumen de una tarjeta baja en consecuencia. La utilización es un cociente nominal y se lee igual en cualquier modo de valor; el saldo incluye la parte en USD al MEP de ese mes.",
  "bank.ratesHeading": "Tasa de financiación vs inflación",
  "bank.ratesNote": "La TEM es la tasa efectiva mensual que imprime cada resumen. La línea punteada es lo que cuesta refinanciar en poder de compra: debajo de cero, la inflación paga los intereses.",
  "bank.legend.balance": "Saldo al cierre",
  "bank.legend.limit": "Límite de compra (por tarjeta)",
  "bank.legend.utilization": "Utilización",
  "bank.legend.tem": "TEM (mensual)",
  "bank.legend.inflation": "Inflación m/m",
  "bank.legend.realTem": "Tasa real mensual",
  "bank.footer": "Esta página lee las condiciones que el banco imprime en cada resumen: el límite de compra, el saldo al cierre y la tasa de financiación. El primer gráfico compara el saldo con el límite. La línea punteada es la parte del límite en uso. Un valor bajo significa margen libre para un mes grande o una emergencia. El segundo gráfico compara la tasa mensual de financiación con la inflación mensual. La línea azul punteada es la tasa real. Cuando esa línea está debajo de cero, la tasa es menor que la inflación, así que un saldo financiado pierde valor más despacio que los pesos con los que se paga. Cuando la línea está arriba de cero, refinanciar tiene un costo verdadero. La ficha del medio reexpresa el límite en pesos constantes. Un límite congelado en pesos nominales se achica en términos reales todos los meses; cuando cae demasiado, ese es el momento de pedirle un aumento al banco.",
